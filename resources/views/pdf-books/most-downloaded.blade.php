...
@section('title', 'សៀវភៅ PDF ពេញនិយម')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">
        <i class="bi bi-bar-chart-fill me-1"></i>ពេញនិយម
    </li>
@endsection

@section('page-icon', 'bar-chart')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="hero-section bg-gradient-primary p-4 rounded-4 shadow-lg position-relative overflow-hidden">
                    ...
                    <div
                        class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-4 position-relative">
                        <div class="text-center text-md-start">

                            <h2 class="fw-bold text-white mb-2">
                                <i class="bi bi-pencil-square me-2"></i> សៀវភៅ PDF ពេញនិយម
                            </h2>
                            <p class="text-white opacity-75 fs-5 mb-0">
                                <i class="bi bi-info-circle me-2"></i>
                                សៀវភៅដែលត្រូវបានទាញយកច្រើនជាងគេទាំង ១០
                            </p>
                        </div>
                ...
                <div class="stat-card-modern bg-white p-4 rounded-4 shadow-sm border-start border-primary border-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 display-6">{{ $mostDownloaded->count() }}</h3>
                ...
                <div class="stat-card-modern bg-white p-4 rounded-4 shadow-sm border-start border-success border-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 display-6">{{ number_format($mostDownloaded->sum('downloads')) }}</h3>
                ...
                <div class="stat-card-modern bg-white p-4 rounded-4 shadow-sm border-start border-warning border-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 display-6">{{ number_format(round($mostDownloaded->avg('downloads'))) }}
                            </h3>
            ...
            <div class="card-header bg-white border-0 p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="fw-bold mb-0">កំពូលតារាងទាញយក</h5>
                    </div>
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td class="py-3">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            @php
                                                $maxDownloads = $mostDownloaded->max('downloads');
                                                $percentage =
                                                    $maxDownloads > 0
                                                        ? round(($pdfBook->downloads / $maxDownloads) * 100)
                                                        : 0;
                                            @endphp
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-5">
                                        <div class="empty-state">
                                            ...
                                            <h4 class="text-muted mb-3">មិនទាន់មានទិន្នន័យទាញយកនៅឡើយទេ</h4>
            ...
            <div class="row g-4 mt-4">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <span class="text-muted small">
                                            {{ $stats['count'] }} ក្បាល | {{ number_format($stats['downloads']) }} ដង
                                        </span>
                                    </div>
                                    @php
                                        $maxCategoryDownloads = $categoryStats->max('downloads');
                                        $categoryPercentage =
                                            $maxCategoryDownloads > 0
                                                ? round(($stats['downloads'] / $maxCategoryDownloads) * 100)
                                                : 0;
                                    @endphp
                ...
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm rounded-4 h-100">
                        ...
                        <div class="card-body p-4 pt-0">
                            @php
                                $totalDownloads = $mostDownloaded->sum('downloads');
                                $avgDownloads = round($mostDownloaded->avg('downloads'));
                                $maxBook = $mostDownloaded->sortByDesc('downloads')->first();
                                $minBook = $mostDownloaded->sortBy('downloads')->first();
                                $topCategory = $categoryStats->sortByDesc('downloads')->keys()->first();
                            @endphp
                            ...
                            <div class="list-group list-group-flush">
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    ...
                                    <span class="badge bg-primary rounded-pill px-3 py-2">
                                        {{ number_format($totalDownloads) }} ដង
                                    </span>
                                </div>
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span>
                                ...
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    ...
                                    <span class="text-truncate" style="max-width: 200px;">
                                        ...
                                        <span
                                            class="badge bg-warning text-dark ms-2">{{ number_format($maxBook->downloads) }}</span>
                                    </span>
                                </div>
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span>
                                    ...
                                    <span class="text-truncate" style="max-width: 200px;">
                                        ...
                                        <span
                                            class="badge bg-secondary ms-2">{{ number_format($minBook->downloads) }}</span>
                                    </span>
                                </div>
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <span>
            ...
            <div class="card border-0 shadow-sm rounded-4 mt-4">
                <div class="card-header bg-white border-0 p-4">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="fw-bold mb-0">ការប្រៀបធៀបចំនួនទាញយក</h5>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="table-responsive">
                        <table class="table table-modern table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach ($mostDownloaded as $index => $pdfBook)
                                    @php
                                        $percentage =
                                            $maxDownloads > 0 ? round(($pdfBook->downloads / $maxDownloads) * 100) : 0;
                                        $barColor =
                                            $index == 0
                                                ? 'bg-gradient-primary'
                                                : ($index == 1
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge-soft badge-soft-info px-3 py-2">
                                                {{ number_format($pdfBook->downloads) }}
                                            </span>
                                        </td>
                                        <td>
