          ...
          <li class="nav-item">
            <router-link :to="{ name: 'dashboard' }" class="nav-link" active-class="active">
              ...
              <p>Dashboard</p>
                    ...
                    <li class="nav-item">
            <router-link :to="{ name: 'pdfbooks' }" class="nav-link" active-class="active">
...
async function loadMoreSearchResults() {
  ...
  const canLoadMoreChats =
    filteredChatMeta.value && filteredChatMeta.value.current_page < filteredChatMeta.value.last_page
  const canLoadMoreUsers =
    filteredUserMeta.value && filteredUserMeta.value.current_page < filteredUserMeta.value.last_page
