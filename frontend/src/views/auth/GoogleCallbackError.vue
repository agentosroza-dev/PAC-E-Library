        ...
        <div class="login-box">
            <div class="card card-outline card-danger">
                <div class="card-body text-center">
                    <div class="mb-3">
                        <i
                            class="fas fa-exclamation-triangle fa-3x text-danger"
                        ></i>
                    </div>
                    <h4 class="login-box-msg text-danger">
                        Google Authentication Failed
                    </h4>
                    <p class="text-muted mb-4">
                        We couldn't sign you in with Google. This could be due
                        to:
                    </p>
                    <ul class="text-left text-muted mb-4">
                        <li>You cancelled the Google sign-in process</li>
                        <li>
                            There was a temporary issue with Google's servers
                        </li>
                        <li>
                            Your Google account may not have the required
                            permissions
                        </li>
                    </ul>
                    <div class="row">
